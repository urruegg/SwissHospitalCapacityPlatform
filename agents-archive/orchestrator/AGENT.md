...
- Modifying any file under `docs/`, `docs/sprints/`, `infra/`, or `agents/<other>/`
...
- [`docs/sprints/sprint-01-orchestrator-mvp.md`](../../docs/sprints/sprint-01-orchestrator-mvp.md) — The sprint that produced this agent.
