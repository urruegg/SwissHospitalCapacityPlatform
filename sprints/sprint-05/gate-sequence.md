...
of [`docs/adr/0007-0011-hardening-delta-summary.md`](../../docs/adr/0007-0011-hardening-delta-summary.md).
...
| ----- | ----- | ----- |
| SIT | All phase issues created and linked; evidence template committed | Issue tree traceable; control artifacts in `sprints/sprint-05/`; markdown lint + link check pass |
