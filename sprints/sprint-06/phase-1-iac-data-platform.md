...
6. MVP agent readiness baseline for OOA/DCA/BMCA with explicit IaC component
   mapping: [`docs/agents/sprint-06-mvp-agent-readiness.md`](../../docs/agents/sprint-06-mvp-agent-readiness.md).
...
- Phase issue: #45 (see sprints/sprint-06/phase-issue-map.md)
- Phase: 1
