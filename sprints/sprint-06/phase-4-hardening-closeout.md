...
- Phase issue: #48 (see sprints/sprint-06/phase-issue-map.md)
- Phase: 4
...
- [x] `npx --yes markdownlint-cli2 "sprints/sprint-06/**/*.md" "docs/agents/sprint-06-*.md" "#node_modules"` — outcome: pass
