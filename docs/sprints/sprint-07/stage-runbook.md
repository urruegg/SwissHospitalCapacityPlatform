# Sprint 07 Stage Runbook (Superpowers)
...
Operationalize the Superpowers Basic Workflow for Sprint 07 with explicit entry
...
1. One isolated worktree per major slice:
   - contracts
   - pipelines
   - product-serving
   - controls
