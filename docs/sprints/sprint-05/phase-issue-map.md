...
[`docs/runbooks/sprint-05-copilot-delegation-runbook.md`](../../runbooks/sprint-05-copilot-delegation-runbook.md).

## Baseline References

1. `docs/sprints/sprint-05-caf-waf-mvp-sit-prod.md` (phase plan and Definition of Done)
