...
1. A DR rehearsal and SIT restore-proof runbook
   ([`docs/runbooks/dr-rehearsal-runbook.md`](../../runbooks/dr-rehearsal-runbook.md))
...
4. The reliability/DR profile updated with the populated
   [Rehearsal Evidence Register](../../operations/reliability-dr-profile.md#rehearsal-evidence-register)
   and [Restore-Proof Register](../../operations/reliability-dr-profile.md#restore-proof-register).
...
- Phase issue: #36 (see docs/sprints/sprint-05/phase-issue-map.md)
- Phase: 3
