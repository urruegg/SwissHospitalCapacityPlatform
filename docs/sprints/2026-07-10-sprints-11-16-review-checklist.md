...
| **Overall** | **56** | **3** | **4** | **6** | **2** | **71** |

**Green rate: 79%** (was 77% mid-day 2026-07-15). Of the 4 remaining red items and 3 partials, all sit in Sprint 15/16 CSA-app-code territory — none of them are Sprint 11-14 or PBI issues, all of which are fully green on code-verifiable criteria. (Root cause history: Sprint 14.1 closed 2026-07-13; Sprint 13.1 partial S13.6 closed 2026-07-14; **S12.4 + S12.6 + S13.9 + S15.1 closed on 2026-07-15**.)
