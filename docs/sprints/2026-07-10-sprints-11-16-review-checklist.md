...
| **Author** | Urs Rüeegg |
| **Status** | Reviewed |
| **Previous Version** | 1.11.0 (day-2 chunk #4c-e results with S12.4 close); this bump captures **day-2 chunk #4f**: **S12.6 fully closed** — workflow-triggered end-to-end run of `adoption-refresh.yml` proven functional (workflow_dispatch run [`29401008792`](https://github.com/urruegg/SwissHospitalCapacityPlatform/actions/runs/29401008792) 08:30 UTC → Fabric job submit HTTP 202 08:31 UTC → Fabric notebook job `32c24fc3-fbe2-468f-ad04-9286f7f1fc15` `Completed` 08:35 UTC, 3min 40s). Both workflows named in the DoD now run cleanly end-to-end: `adoption-refresh.yml` (verified today) + `entra-whatif.yml` (verified 2026-07-09, whatif-only per its name). |
...
| **Overall** | **54** | **3** | **5** | **7** | **2** | **71** |

**Green rate: 76%** (was 75% on 2026-07-15 am, 73% on 2026-07-14). Of the 5 remaining red items and 3 partials, **6 collapse to 2 root causes** — none of them are Sprint 11 or PBI issues, both of which are fully green on code-verifiable criteria. (The former third root cause — Sprint 14.1 — was closed on 2026-07-13; Sprint 13.1 partial S13.6 closed on 2026-07-14; **S12.4 + S12.6 closed on 2026-07-15**.)
