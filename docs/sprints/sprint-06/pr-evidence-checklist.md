...
- Phase issue: #<phase-issue>  (see docs/sprints/sprint-06/phase-issue-map.md)
- Phase: <0|1|2|3|4>
...
- [ ] `lychee docs/**/*.md docs/sprints/*.md docs/sprints/**/*.md .github/*.md AGENTS.md README.md` — outcome: <pass|fail>
