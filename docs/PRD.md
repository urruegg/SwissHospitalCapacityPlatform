...
| **Author** | Urs Rueegg |
| **Status** | Reviewed |
| **Previous Version** | 2.7.1 (added the Curavias brand-kit logo to the document header); this bump restores the missing `### R)` NFR-BVA governance section (rows NFR-BVA-001..004 + header) that §7 traceability already references |
