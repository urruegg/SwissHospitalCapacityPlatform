...
| **Author** | Urs Rueegg |
| **Status** | Reviewed |
| **Previous Version** | 2.2.0 (added Sprint 27 UX-polish FR-UX-001..006 + NFR-UX-001..004 and merged Sprint 29 context-architecture requirements); this bump adds the Sprint 31 Data Quality Agent requirements FR-DQA-001..006/010/012 + NFR-DQA-001..002 and their traceability row (#451, #453) |
