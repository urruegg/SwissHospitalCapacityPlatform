...
| `hcp:ORSlot` | `ORSlot` | `DC-OR-SCHEDULE-v1` *(draft — RB-10)*; `DC-OR-CASE-v1` *(draft — RB-10)* | Deferred to Sprint 10/11 (OR-status feed) | New entity in MVO; the OR steering anchor per AMA F-A-06. |
