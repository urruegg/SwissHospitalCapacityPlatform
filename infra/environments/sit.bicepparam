...
param poAgentContainerImage = 'cri75lbu5sj4hza.azurecr.io/po-agent-service:bed0da5'
...
// Image built by ci-build-app-fluent.yml (run 31627008284, S44 Option C slice 3b:
// OccupancyBoard renders live payload.signals from the golden source). approval-gated per AGENTS.md.
param appFluentImage = 'cri75lbu5sj4hza.azurecr.io/hcc-app-fluent:9ffec86'
