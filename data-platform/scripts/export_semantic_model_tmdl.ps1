...
$script:ExpectedTotal    = 29    # Sprint 09: 14; +2 from M2 (encounter→dim_hospital, bed_assignment→dim_hospital); +9 from Sprint 15 BVA; +4 from Sprint 23 WS-C1 additive org spine (map_hospital_org→dim_hospital, map_hospital_org→dim_org_unit, dim_org_unit→dim_tenant, dim_department→dim_org_unit)
